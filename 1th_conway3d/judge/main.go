...
var points = []PointConfigureInterface{
	Point(2048, "256.dat", "256.dat.out", "00:00:03", 1.30, 1, 10),
	Point(1024, "512.dat", "512.dat.out", "00:00:10", 3.80, 1, 20),
	Point(1024, "1024.dat", "1024.dat.out", "00:01:00", 26.50, 1, 70),
}
